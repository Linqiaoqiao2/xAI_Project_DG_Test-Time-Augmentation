...
def get_dataset(dataset_name, data_dir, test_envs=None, hparams=None):
    """
    通用入口：根據 dataset 名稱回傳實例化資料集（MultipleDomainDataset 類別）
    """
    if dataset_name not in globals():
    ...
    return dataset_class(data_dir, test_envs, hparams)
