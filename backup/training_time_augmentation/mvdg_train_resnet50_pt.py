# -*- coding: utf-8 -*-
"""
MVDG-style Meta-Learning Pipeline (ResNet-50) for PACS Dataset
...
SAVE_ROOT = "/home/proj25gr5/xAI_neu/models_mvdg_train_only_resnet50"
        ...
        for target_domain in PACS_DOMAINS:
            ...
            for epoch in range(NUM_EPOCHS):
                ...
                if val_acc > best_val_acc:
                    ...
                    model_path = os.path.join(SAVE_ROOT, f"resnet50_seed{seed}_target{target_domain}.pth")
