# -*- coding: utf-8 -*-
"""
Train ResNet-18 on PACS with LODO using Custom Augmentation (Train Only)
...
SAVE_ROOT = "/home/proj25gr5/xAI_neu/pretrained_resnet18_custom_aug"
...
if __name__ == "__main__":
    ...
    for seed in SEEDS:
        ...
        for target_domain in PACS_DOMAINS:
            ...
            model_path = os.path.join(save_dir, f"resnet18_custom_target_{target_domain}.pth")
