# -*- coding: utf-8 -*-
"""
Evaluate ResNet18 models (custom training augmentation) with Custom TTA (testing)
"""

import torch
import sys
sys.path.append("/home/proj25gr5/xAI")  # baseline_resnet18.py 所在位置
...
model_base_dir = "/home/proj25gr5/xAI_neu/pretrained_resnet18_custom_aug"
...
for domain in domains:
    ...
    for seed in seeds:
        ...
        model_path = os.path.join(model_base_dir, f"custom_seed_{seed}", f"resnet18_custom_target_{domain}.pth")
...
save_dir = f"/home/proj25gr5/xAI_neu/TTA_resnet18_custom_only_{now}"
os.makedirs(save_dir, exist_ok=True)

result_file = os.path.join(save_dir, "tta_results_resnet18_custom_only.json")
plot_file = os.path.join(save_dir, "tta_plot_resnet18_custom_only.png")
...
plt.bar(domains, accs, label="Custom TTA", color='salmon')
plt.ylabel("Average Accuracy")
plt.title("Custom TTA on ResNet18 (Custom Training)")
plt.ylim(0, 1)
plt.legend()
plt.tight_layout()
